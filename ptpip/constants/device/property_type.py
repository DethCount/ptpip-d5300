...
class DevicePropertyType(Enum):
    ...
    FunctionButton                  = 0xD084
    CommandDialRotation             = 0xD085
    ...
    InternalFlashPopup              = 0xD1C0
    InternalFlashStatus             = 0xD1C1
